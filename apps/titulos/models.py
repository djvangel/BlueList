...
from ..tags.models import Estado, Estacion, Genero, Formato
...
class Personaje(models.Model):
    ...
    obra = models.ForeignKey(Titulo, related_name='personajes', on_delete=models.CASCADE, null=True, blank=True)
